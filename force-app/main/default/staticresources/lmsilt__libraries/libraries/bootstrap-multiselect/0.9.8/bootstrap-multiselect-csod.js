    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                if (options.length === 0) {
                    return '<span class="selectedText">' + this.nonSelectedText + '</span> <b class="caret"></b>';
                }
                else if (options.length == $('option', $(select)).length) {
                    return '<span class="selectedText">' + this.allSelectedText + '</span> <b class="caret"></b>';
                }
                else if (options.length > this.numberDisplayed) {
                    return '<span class="selectedText">' + options.length + ' ' + this.nSelectedText + '</span> <b class="caret"></b>';
                }
                else {
                    var selected = '';
                    ...
                    return '<span class="selectedText">' + selected.substr(0, selected.length - 2) + '</span> <b class="caret"></b>';
                }
            },
            /**
