...
function ValidateSearch(){
    if($j("[id$=nameSearch]").val().trim() === '' && $j("[id$=clientSearch]").val().trim() === '' && $j("[id$=subjectSearch]").val().trim() === '' && $j("[id$=lobSearch]").val().trim() === '' && $j("[id$=jobTypeSearch]").val().trim() === ''  && $j("[id$=industryGroupSearch]").val().trim() === '' && $j("[id$=stageSearch]").val().trim() === '' && $j("[id$=oppNumberSearch]").val().trim() === '' && $j("[id$=oitSearch]").val().trim() === '')
    {
...
function GetSearchCriteria(){
    ...
    if($j("[id$=nameSearch]").val() !== '')
        criteria += '   Opportunity Name: ' + $j("[id$=nameSearch]").val();
    if($j("[id$=oppNumberSearch]").val() !== '')
        criteria += '   Opportunity Number: ' + $j("[id$=oppNumberSearch]").val();
