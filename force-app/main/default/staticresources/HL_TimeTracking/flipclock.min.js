...
function(a) {
    ...
    FlipClock.Factory = FlipClock.Base.extend({
        ...
        start: function(a) {
            var b = this;
			if(a==undefined)a=parseInt(0)
			b.time.time=parseInt(a);
			console.log(' b.time.time..'+b.time.time);
