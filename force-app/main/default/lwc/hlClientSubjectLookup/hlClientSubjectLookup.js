import lookUp from '@salesforce/apex/HLClientSubjectLookup.lookUp';
...
export default class HlClientSubjectLookup extends LightningElement {
    @api valueId;
    @api objName;
    @api iconName;
    @api labelName;
...
console.log('data123-- '+JSON.stringify(data));
        if (data) {
            ...
            this.error = error;
            this.record = undefined;
            console.log("this.error+++____", this.error);
        }
    }
