({
    ...
    firEventToPopulateDatainParentComponent : function(component,event){
        var cmpEvent = component.getEvent("listOfIds");
        cmpEvent.setParams({"selectedRecords" : component.get('v.selectedRecords'),
