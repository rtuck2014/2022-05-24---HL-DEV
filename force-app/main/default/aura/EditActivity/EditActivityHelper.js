            ...
            if(state === "SUCCESS"){
                ...
                getActivityTypesAction.setCallback(this, function(response){
                    ...
                    if(state === "SUCCESS"){
                        ...
                        var currentType = component.find("type").get("v.value");
                        if(currentType === 'Follow-up Internal' || currentType === 'Follow-up External')
                        	options.push({class:"", label: currentType, value: currentType});
                        component.set("v.activityTypes", activityTypes);
                        component.find("type").set("v.options", options);
                        this.onTypeChanged(component, helper, false);
                    }                           
                });
